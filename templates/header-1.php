...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown mr-2">
                        ...
                        <ul aria-labelledby="dropdownMenu1" class="dropdown-menu border-1 shadow">
                            <li><a href="#" class="dropdown-item">Teaching Staff </a></li>
                            <li><a href="#" class="dropdown-item">Administrative people</a></li>
                            <li><a href="#" class="dropdown-item">Technical Staff </a></li>
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul aria-labelledby="dropdownMenu2" class="dropdown-menu border-2 shadow">
                                    <li>
                                        <a tabindex="-1" href="#" class="dropdown-item">Scholars</a>
                                    </li>
                                    <li>
                                        <a tabindex="-1" href="#" class="dropdown-item">UG & PG</a>
                                    </li>
                                </ul>
                            </li>
                            <!-- End Level two -->
                        ...
                        <ul aria-labelledby="dropdownMenu1" class="dropdown-menu border-0 shadow">
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul aria-labelledby="dropdownMenu3" class="dropdown-menu border-0 shadow">
                                    <li>
                                        <a tabindex="-1" href="#" class="dropdown-item">Student Association</a>
                                    </li>
                                    <li>
                                        <a tabindex="-1" href="#" class="dropdown-item">Student Projects</a>
                                    </li>
                                    <li>
                                        <a tabindex="-1" href="#" class="dropdown-item">Inter-Institute Events</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="dropdown-submenu">
                                ...
                                <ul aria-labelledby="dropdownMenu4" class="dropdown-menu border-0 shadow">
                                    <li>
                                        <a tabindex="-1" href="#" class="dropdown-item">Conferences Attended</a>
                                    </li>
                                    <li>
                                        <a tabindex="-1" href="#" class="dropdown-item">Journals Published</a>
                                    </li>
                                    <li>
                                        <a tabindex="-1" href="#" class="dropdown-item">Faculty Development Program</a>
                                    </li>
    ...
    $(function() {
        ...
        // ------------------------------------------------------ //
        $("ul.dropdown-menu [data-toggle='dropdown'] li.dropdown [data-toggle='dropdown']").on("mouseover",
            function(event) {
