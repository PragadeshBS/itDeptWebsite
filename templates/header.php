    ...
    <header>
        ...
        <nav>
            ...
            <div class="parent" style="z-index:4;">
                ...
                <div class="child-1">                
                    ...
                    <div class="child-1-parent">
                        Regulations<i class="bi bi-caret-down-fill"></i>
                        <div class="child-2">   
                            <div class="child-2-parent">
                                UG<i class="bi bi-caret-down-fill"></i>
                                <div class="child-3">
                            ...
                            <div class="child-2-parent">
                                PG<i class="bi bi-caret-down-fill"></i>
                                <div class="child-3">
                    ...
                    <div class="child-1-parent">
                        Curriculum and Syllabi<i class="bi bi-caret-down-fill"></i>
                        <div class="child-2">   
                            <div class="child-2-parent">
                                UG-IT<i class="bi bi-caret-down-fill"></i>
                                <div class="child-3">
            ...
            <div class="parent" style="z-index:2;">
                ...
                <div class="child-1">                
                    <div class="child-1-parent">
                        Student Events<i class="bi bi-caret-down-fill"></i>
                        <div class="child-2">
                    ...
                    <div class="child-1-parent">
                        Faculty Events<i class="bi bi-caret-down-fill"></i>
                        <div class="child-2">                              
            ...
            <div class="parent" style="z-index:1;">
                ...
                <div class="child-1">
                    ...
                    <div class="child-1-parent">
                        Faculty Awards<i class="bi bi-caret-down-fill"></i>
                        <div class="child-2">
